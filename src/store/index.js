  ...
  state: () => {
    return {
      ...
      defaultNewsArr: [
        ...
        { label: "Github", name: "github", order: 40, show: true },
        { label: "快手", name: "kuaishou", order: 41, show: true },
        { label: "靠谱新闻", name: "kaopu", order: 42, show: true },
        { label: "金十数据", name: "jin10", order: 43, show: true },
        { label: "牛客", name: "nowcoder", order: 44, show: true },
        { label: "凤凰网", name: "ifeng", order: 45, show: true },
        { label: "虫部落", name: "chongbuluo", order: 46, show: true },
        { label: "豆瓣综合", name: "douban", order: 47, show: true },
        { label: "Steam", name: "steam", order: 48, show: true },
        { label: "Freebuf", name: "freebuf", order: 49, show: true },
        { label: "腾讯视频", name: "qqvideo", order: 50, show: true },
        { label: "爱奇艺", name: "iqiyi", order: 51, show: true },
      ],
      newsArr: [],
      // 链接跳转方式
      linkOpenType: "open",
